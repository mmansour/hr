...
keywords = ["retreat", "organic", "wellness", "spa", "boutique", "green", "organic wine"]
#keywords = [""]
...
for h in responsedict['HotelListResponse']['HotelList']['HotelSummary']:
    for word in keywords:
        if word.lower() in h['shortDescription'].lower():
            print h['shortDescription'].replace('&lt;','<').replace('&gt;', '>').replace("&apos;","'")
...
#
#for img in responsedict['HotelInformationResponse']['HotelImages']['HotelImage']:
#    print img['url'].replace('images.travelnow.com', 'media.hotelretreats.com')
#    print img['thumbnailUrl'].replace('images.travelnow.com', 'media.hotelretreats.com')
#    print img['height']
#
#    try:
#        print img['caption']
