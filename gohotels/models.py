...
class HotelPage(Displayable):
    ...
    thumbnail_url = models.CharField(max_length=40, verbose_name="Thumbnail Url", blank=True, null=True)
...
#    address2 = models.CharField(max_length=400, verbose_name="Address 2", blank=True, null=True)
    ...
    rate_currency_code = models.CharField(max_length=10, verbose_name="Rate Currency Code", blank=True, null=True)
